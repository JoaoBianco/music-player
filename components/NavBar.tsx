...
const NavBar = () => {
  ...
  return (
    <nav
      className={`bg-teal-400  transition-all ease-in-out duration-300 shadow-2xl flex flex-col items-center p-4 text-white max-w-[250px] w-${
    ...
    >
      ...
      <div
        ...
        className="mt-auto w-full shadow-md border-2 rounded-lg text-center"
      >
        <p className="font-bold cursor-pointer hover:bg-teal-500 p-4">Sair </p>
      </div>
    </nav>
  );
};
